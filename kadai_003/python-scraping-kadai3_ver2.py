...
#アイコンクリック
icon_button=chrome_driver.find_element(By.CSS_SELECTOR,'div.sc-jeToga.kharXk>img')
icon_button.click()

#アカウント設定クリック
acount_button=chrome_driver.find_element(By.CSS_SELECTOR,'a>li.sc-jFmBXp.ezvGOM')
acount_button.click()
